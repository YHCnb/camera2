...
Java_com_example_android_camera2_basic_face_FaceTracker_native_1create(JNIEnv *env, jobject thiz,
...
Java_com_example_android_camera2_basic_face_FaceTracker_native_1start(JNIEnv *env, jobject thiz,
                                                               jlong self) {
    if (self == 0) {
        return;
    }
...
JNIEXPORT void JNICALL
Java_com_example_android_camera2_basic_face_FaceTracker_native_1stop(JNIEnv *env, jobject thiz,
                                                              jlong self) {
    if (self == 0) {
        return;
    }
...
Java_com_example_android_camera2_basic_face_FaceTracker_native_1detector(JNIEnv *env, jobject thiz,
    ...
    LOGD(" ret :%d", ret);
    if (ret) {
        jclass clazz = env->FindClass("com/example/android/camera2/basic/face/Face");
...
JNIEXPORT void JNICALL
Java_com_example_android_camera2_basic_face_FaceTracker_saveYUV(JNIEnv *env, jclass clazz,
                                                         jbyteArray yuv) {
